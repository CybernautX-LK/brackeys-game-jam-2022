...
namespace Gridbased
{
    public class BoardManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private bool setupSceneOnStart;
        ...
        public Count enemyCount = new Count(3, 5);
        ...
        void InitialiseList()
        {
            ...
            for (int x = 1; x < columns - 1; x++)
            {
                ...
                for (int y = 1; y < rows - 1; y++)
                {
                    ...
                    gridPositions.Add(new Vector3(x, y, 0f) + (Vector3)boardOffset);
                }
            }
        }
        ...
        void BoardSetup()
        {
            ...
            for (int x = -1; x < columns + 1; x++)
            {
                ...
                for (int y = -1; y < rows + 1; y++)
                {
                    ...
                    GameObject instance = Instantiate(toInstantiate, new Vector3(x, y, 0f) + (Vector3)boardOffset, Quaternion.identity) as GameObject;
